<?php 
      include 'header.php';
        ...
        if(isset($_GET['del'])){
          ...
          $id=$_GET['del'];
          $sql="DELETE FROM km_conf WHERE `conf_id` = $id";
          $res=del($sql);
          if($res['code']==1){
        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  <div class="panel-title">网站列表</div>
                  <a href="conf_add.php" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加网站配置信息</a>
                </div>
                <form action="" method="post">
                <div class="panel-body">
                  <h2 class="panel-body-title">网站配置信息</h2>
                  <table class="table table-striped table-bordered table-hover dataTable">
                      ...
                      <?php foreach($confinfo['data'] as $v){ ?>
                    	<tr class="success">
