 <?php
    include 'header.php';
    //查询轮播图信息
    $sql='SELECT * FROM km_banner';
    $bannerinfo=select($sql);
			...
			<div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <table class="table table-striped table-bordered table-hover dataTable">
                      ...
                      <?php foreach($bannerinfo as $v){ ?>
                      <tr class="success">
                        <td class="text-center"><input type="checkbox" value="1" name="idarr[]" class="cbox"></td>
                        <td><?php echo $v['ban_name'] ?></td>
                        <td><img src="<?php if($v['ban_thumb'] != ""){ echo $v['ban_thumb'];}else{ 
                          echo   "./include/thumb.php?imgs=".$v['ban_imges'];} ?>" /></td>
                        <td>
                          <div class="btn-group">
