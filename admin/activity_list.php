 <?php
    include 'header.php';
    //查询轮播图信息
    $sql='SELECT * FROM km_marvellous_type';
    $martypeinfo=select($sql);
        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  ...
                  <a href="activity_add.php" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加</a>
                </div>
                <form action="" method="post">
                <div class="panel-body">
                  <h2 class="panel-body-title">活动</h2>
                  <table class="table table-striped table-bordered table-hover dataTable">
                      ...
                      <?php  if($martypeinfo != null){ foreach($martypeinfo as $v){ ?>
                      <tr class="success">
                        <td class="text-center"><input type="checkbox" value="1" name="idarr[]" class="cbox"></td>
                        <td><?php echo $v['Marvellous_type_name'] ?></td>
                        <td><img src="<?php 
                          echo   "./include/thumb.php?imgs=".$v['Marvellous_type_img']; ?>" /></td>
                        <td>
                          <div class="btn-group">
                            <a href="activity_add.php?edit=<?php  echo $v['Marvellous_type_id'] ?>" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
